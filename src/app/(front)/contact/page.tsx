    ...
    const contactInfo = [
        {
            icon: MapPin,
            title: 'Visit Us',
            content: siteConfig?.address || '123 Travel Street, Tourism City',
            details: 'Visit us at our office'
        },
        {
            icon: Phone,
            title: 'Call Us',
            content: siteConfig?.phone || '+1 (555) 123-4567',
            details: siteConfig?.hotline ? `Hotline: ${siteConfig.hotline}` : 'Mon-Fri: 9AM - 6PM'
        },
        {
            icon: Mail,
            title: 'Email Us',
            content: siteConfig?.email || 'info@rbstravels.com',
            details: 'We reply within 24 hours'
        },
        {
            icon: Clock,
            title: 'Working Hours',
            content: siteConfig?.workingHours || 'Monday - Friday',
                    ...
                    <div className='gap-12 grid grid-cols-1 lg:grid-cols-2'>
                        ...
                        <div className='space-y-6'>
                            ...
                            <Card className='overflow-hidden'>
                                <div className='relative bg-muted w-full h-[400px]'>
                                    <iframe
                                ...
                                <CardContent className='pt-6'>
                                    ...
                                    <div className='space-y-4'>
                                        ...
                                        <div>
                                            ...
                                            <Typography variant='caption' className='text-muted-foreground'>
                                                Yes! Feel free to call us during business hours for immediate assistance.
                                            </Typography>
                                        </div>
                                        <div>
                                            <Typography variant='body2' weight='medium' className='mb-1'>
                                            ...
                                            <Typography variant='caption' className='text-muted-foreground'>
                                                Absolutely! We welcome walk-ins, but appointments are recommended.
                                            </Typography>
                                        </div>
                                    </div>
                                </CardContent>
