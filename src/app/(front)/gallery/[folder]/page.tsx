...
export default function GalleryPage() {
    ...
    const apiPath = useMemo(() => {
        return `/media?path=%2Fstring%2F${encodeURIComponent(decodedFolderName)}&page=1&perPage=100&fileType=image`
    }, [decodedFolderName])
                    ...
                    <Container>
                        <div className='py-12 text-white text-center'>
                            <Typography variant='h1' weight='bold' className='mb-4'>
                                {decodedFolderName.replace(/-/g, ' ').replace(/\b\w/g, (l) => l.toUpperCase())}
                            </Typography>
