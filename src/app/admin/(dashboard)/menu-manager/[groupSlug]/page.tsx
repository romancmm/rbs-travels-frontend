        ...
        <div className='flex-1 gap-6 grid grid-cols-none lg:grid-cols-4 py-6 overflow-y-auto'>
            ...
            <div className='space-y-4'>
                        ...
                        <div className='flex justify-between items-center py-3 border-slate-100 border-b'>
                            <div className='flex items-center gap-3'>
                                ...
                                <div>
                                    ...
                                    <p className='mt-0.5 font-semibold text-slate-900 text-sm capitalize'>{menu.position}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex justify-between items-center py-3 border-slate-100 border-b'>
                            <div className='flex flex-1 items-center gap-3 min-w-0'>
                                ...
                                <div className='flex-1 min-w-0'>
                                    ...
                                    <code className='block mt-0.5 font-mono text-slate-700 text-xs truncate'>{menu.slug}</code>
                                </div>
                            </div>
                        </div>
                ...
                <div className='bg-slate-50 p-5 border border-slate-200 rounded-2xl'>
                    <h4 className='mb-3 font-semibold text-slate-600 text-xs uppercase tracking-wide'>Quick Actions</h4>
