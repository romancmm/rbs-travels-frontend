...
export type Feature = {
  ...
  href: string
  badge?: string
  color: 'primary' | 'accent' | 'success' | 'warning' | 'purple' | 'pink' | 'blue' | 'sky'
}
...
const colorClasses = {
  ...
  sky: {
    ...
    icon: 'bg-sky-500/10 text-sky-600 group-hover:bg-sky-500/20',
        ...
        return (
          ...
          >
            <Link href={feature.href}>
              ...
              >
                <div
                  className={cn('absolute inset-0 bg-linear-to-br opacity-40', colors.gradient)}
                />
