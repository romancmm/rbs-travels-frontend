...
export function Canvas() {
  ...
  const handleAddSection = () => {
    const sectionNumber = content.sections.length + 1
    const newSection = createDefaultSection(`Section ${sectionNumber}`)
      ...
      >
        ...
        {content.sections.length === 0 && (
          <div className='flex flex-col justify-center items-center bg-white p-12 border-2 border-gray-300 border-dashed rounded-lg min-h-[500px] text-center'>
            ...
            <h3 className='mt-4 font-semibold text-gray-900 text-lg'>Start building your page</h3>
            ...
            <Button onClick={handleAddSection} size='lg' className='gap-2 mt-6'>
        ...
        {content.sections.length > 0 && (
          <SortableContext items={sectionIds} strategy={verticalListSortingStrategy}>
            <div className='space-y-4'>
              ...
              {/* Add Section Button - Always visible at the bottom */}
              <div className='flex justify-center pt-4'>
                <Button
                  onClick={handleAddSection}
                  variant='outline'
                  size='lg'
                  className='gap-2 hover:bg-blue-50 border-2 hover:border-blue-400 border-dashed'
                >
                  <Plus className='w-5 h-5' />
                  Add Section
                </Button>
