...
interface LayoutControlProps {
  ...
  onChange: (
    type: 'flex' | 'grid' | 'block',
    config: FlexConfig | GridConfig | null,
    className: string
  ) => void
}
...
export function LayoutControl({
  ...
  return (
    <div className='space-y-4'>
      ...
      <Tabs
        value={layoutType}
        onValueChange={(val: any) => handleTypeChange(val as 'flex' | 'grid' | 'block')}
      >
        ...
        <TabsContent value='flex' className='space-y-3'>
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleFlexChange({ ...flexConfig, direction: val as any })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleFlexChange({ ...flexConfig, justify: val as any })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleFlexChange({ ...flexConfig, align: val as any })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleFlexChange({ ...flexConfig, wrap: val as any })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleFlexChange({ ...flexConfig, gap: val })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
        ...
        <TabsContent value='grid' className='space-y-3'>
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleGridChange({ ...gridConfig, cols: parseInt(val) })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) =>
                handleGridChange({
                  ...gridConfig,
                  rows: val === 'auto' ? undefined : parseInt(val)
                })
              }
            >
              <SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleGridChange({ ...gridConfig, gap: val })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleGridChange({ ...gridConfig, justifyItems: val as any })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className='space-y-2'>
            ...
            <Select
              ...
              onValueChange={(val) => handleGridChange({ ...gridConfig, alignItems: val as any })}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
