          ...
          {banners.map((banner, index) => (
            <CarouselItem key={banner.id}>
              ...
              >
                ...
                <div className='absolute inset-0 bg-linear-gradient-to-b from-black/30 via-black/50 to-black/70' />
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <div className='absolute inset-0 bg-linear-gradient-to-r from-primary/60 via-primary to-primary/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500' />
                          {/* Shine effect */}
                          <div className='absolute inset-0 bg-linear-gradient-to-r from-transparent via-white/20 to-transparent transition-transform -translate-x-full group-hover:translate-x-full duration-700' />
                        </Button>
                        ...
                        >
                          ...
                          <div className='absolute inset-0 bg-linear-gradient-to-r from-white/5 to-white/10 opacity-0 group-hover:opacity-100 rounded-full transition-opacity duration-300' />
                        </Button>
                      </motion.div>
